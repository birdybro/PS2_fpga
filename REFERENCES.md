...
ADDU, SUBU, AND, OR, XOR, NOR, SLT, and SLTU interpreter operations in this public emulator. It independently
...
for SLT and SLTU. The project implements that behavior independently in
