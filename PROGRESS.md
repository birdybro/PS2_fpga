...
- Last completed milestone: M071 — implement R5900 AND
- Next milestone: M072 — implement R5900 OR
- Current subsystem: R5900 32-bit arithmetic register execution
- Current regression status: 398 tests pass with no skips; AND directed/reference checks and 524-case sequential randomized differential coverage are green
- Known architectural inaccuracies: only NOP, six 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, and AND execute; reserved words emit diagnostics but do not enter COP0 exceptions
...
- Most recent pushed commit: M071 milestone commit (this commit)
...
32-bit shift instructions plus LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, and AND now execute,
