...
- Last completed milestone: M072 — implement R5900 OR
- Next milestone: M073 — implement R5900 XOR
- Current subsystem: R5900 32-bit arithmetic register execution
- Current regression status: 409 tests pass with no skips; OR directed/reference checks and 524-case sequential randomized differential coverage are green
- Known architectural inaccuracies: only NOP, six 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, AND, and OR execute; reserved words emit diagnostics but do not enter COP0 exceptions
...
- Most recent pushed commit: M072 milestone commit (this commit)
...
32-bit shift instructions plus LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, AND, and OR now execute,
