...
module r5900_decode (
    ...
    always_comb begin
        ...
        if (instruction_i == 32'd0) begin
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DSRAV;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[10:6] == 5'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MULT;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[10:6] == 5'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MULTU;
        end else if (
            (instruction_i[31:26] == 6'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DIV;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[15:6] == 10'h000)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DIVU;
        end else if (
            (instruction_i[31:26] == 6'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MFHI;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[25:16] == 10'h000)
            && (instruction_i[10:6] == 5'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MTLO;
        end else if (
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MULT1;
        end else if (
            (instruction_i[31:26] == 6'h1c)
            && (instruction_i[10:6] == 5'h00)
            && (instruction_i[5:0] == 6'h19)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MULTU1;
        end else if (
            (instruction_i[31:26] == 6'h1c)
            && (instruction_i[15:6] == 10'h000)
            && (instruction_i[5:0] == 6'h1a)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DIV1;
        end else if (
            (instruction_i[31:26] == 6'h1c)
            && (instruction_i[15:6] == 10'h000)
            && (instruction_i[5:0] == 6'h1b)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DIVU1;
        end else if (
            (instruction_i[31:26] == 6'h1c)
            && (instruction_i[25:16] == 10'h000)
            && (instruction_i[10:6] == 5'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_MFHI1;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[10:6] == 5'h00)
            ...
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DADDU;
        end else if (
            (instruction_i[31:26] == 6'h00)
            && (instruction_i[10:6] == 5'h00)
        ...
        end else if (instruction_i[31:26] == 6'h19) begin
            legal_o = 1'b1;
            operation_o = R5900_OPERATION_DADDIU;
