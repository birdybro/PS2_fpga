...
six canonical 32-bit shifts, DSLL, DSRL, DSRA, LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU,
...
All 22 entries in the initial scalar foundation are complete. Three of the 32
rows added by the doubleword and dual-HI/LO roadmap are complete; the other 29
