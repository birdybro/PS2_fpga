...
canonical 32-bit shifts, LUI, ORI, ANDI, XORI, and ADDIU are implemented with
...
NOP, all six 32-bit shifts, LUI, ORI, ANDI, XORI, and ADDIU are complete; the
other 10 entries in the initial R5900 ISA coverage matrix remain pending. The
