...
canonical 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, and ADDU are implemented with
...
NOP, all six 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, and ADDU are complete;
the other 9 entries in the initial R5900 ISA coverage matrix remain pending. The
