...
canonical 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, and AND are implemented with
...
NOP, all six 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, SUBU, and AND are
complete; the other 7 entries in the initial R5900 ISA coverage matrix remain pending. The
