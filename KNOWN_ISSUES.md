...
canonical 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, and SUBU are implemented with
...
NOP, all six 32-bit shifts, LUI, ORI, ANDI, XORI, ADDIU, ADDU, and SUBU are
complete; the other 8 entries in the initial R5900 ISA coverage matrix remain pending. The
