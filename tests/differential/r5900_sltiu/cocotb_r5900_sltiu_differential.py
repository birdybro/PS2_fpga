"""Randomized differential verification for R5900 SLTIU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_sltiu
...
@cocotb.test()
async def test_r5900_sltiu_against_python_model(dut) -> None:
