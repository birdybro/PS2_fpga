"""Randomized differential verification for R5900 NOR."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_nor
...
@cocotb.test()
async def test_r5900_nor_against_python_model(dut) -> None:
