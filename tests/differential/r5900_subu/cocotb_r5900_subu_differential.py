"""Randomized differential verification for R5900 SUBU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_subu
...
@cocotb.test()
async def test_r5900_subu_against_python_model(dut) -> None:
