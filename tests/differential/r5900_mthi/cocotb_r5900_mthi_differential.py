"""Randomized differential verification for R5900 MTHI."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_mthi
...
async def execute_case(
    ...
    """Execute and compare one complete differential MTHI transition."""
    instruction = encode_mthi(source)
    old_pc = model.pc
    expected_hi = model.read_gpr(source) & SCALAR_MASK
...
@cocotb.test()
async def test_r5900_mthi_against_python_architectural_model(dut) -> None:
