"""Pytest orchestration for R5900 DADDIU differential verification."""
...
TESTBENCH_DIR = Path(__file__).resolve().parent / "r5900_daddiu"
...
def test_r5900_daddiu_differential() -> None:
    sources = [
    ...
    build_dir = build_root / "pytest" / "r5900_daddiu_differential"
    ...
    result = runner.test(
        test_module="cocotb_r5900_daddiu_differential",
        hdl_toplevel="r5900_shift_immediate_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        seed=int(os.environ.get("RANDOM_SEED", "1")),
        results_xml=str(build_root / "results/cocotb-r5900-daddiu-differential.xml"),
    )
