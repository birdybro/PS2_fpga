"""Randomized differential verification for R5900 SLT."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_slt
...
@cocotb.test()
async def test_r5900_slt_against_python_model(dut) -> None:
