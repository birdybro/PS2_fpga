"""Randomized differential verification for R5900 ANDI."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_andi
...
@cocotb.test()
async def test_r5900_andi_against_python_model(dut) -> None:
