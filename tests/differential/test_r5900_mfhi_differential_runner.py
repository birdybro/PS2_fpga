"""Pytest orchestration for randomized differential R5900 MFHI verification."""
...
def test_r5900_mfhi_randomized_differential() -> None:
    """Compare MFHI state and events against the Python architectural model."""
    seed = int(os.environ.get("RANDOM_SEED", "1"))
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_mfhi_differential"
    results_path = build_root / "results" / "cocotb-r5900-mfhi-differential.xml"
    ...
    result = runner.test(
        test_module="cocotb_r5900_mfhi_differential",
        hdl_toplevel="r5900_mult_top",
        build_dir=build_dir,
