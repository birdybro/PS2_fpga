"""Randomized differential verification for R5900 XORI."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_xori
...
@cocotb.test()
async def test_r5900_xori_against_python_model(dut) -> None:
