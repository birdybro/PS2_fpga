"""Randomized differential verification for R5900 ADDU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_addu
...
@cocotb.test()
async def test_r5900_addu_against_python_model(dut) -> None:
    ...
    for iteration, (destination, source_a, source_b) in enumerate((*boundaries, *random_cases)):
