"""Pytest orchestration for randomized differential R5900 DIV1 verification."""
...
def test_r5900_div1_randomized_differential() -> None:
    """Compare DIV1 state and events against the Python architectural model."""
    seed = int(os.environ.get("RANDOM_SEED", "1"))
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_div1_differential"
    results_path = build_root / "results" / "cocotb-r5900-div1-differential.xml"
    ...
    result = runner.test(
        test_module="cocotb_r5900_div1_differential",
        hdl_toplevel="r5900_div1_top",
        build_dir=build_dir,
