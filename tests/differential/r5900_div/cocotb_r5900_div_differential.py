"""Randomized differential verification for R5900 signed word DIV."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_div
...
@cocotb.test()
async def test_r5900_div_against_python_architectural_model(dut) -> None:
    """Compare PC, GPRs, both accumulator lanes, and events over DIV cases."""
