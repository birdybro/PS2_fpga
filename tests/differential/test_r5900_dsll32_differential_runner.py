"""Pytest orchestration for differential R5900 DSLL32 tests."""
...
TEST_DIR = Path(__file__).resolve().parent / "r5900_dsll32"
HARNESS = ROOT / "tests/unit/r5900_shift_immediate"


@pytest.mark.differential
@pytest.mark.randomized
def test_r5900_dsll32_randomized_differential() -> None:
    sources = [
    ...
    directory = build / "pytest/r5900_dsll32_differential"
    ...
    result = runner.test(
        test_module="cocotb_r5900_dsll32_differential",
        hdl_toplevel="r5900_shift_immediate_top",
        build_dir=directory,
        test_dir=TEST_DIR,
        results_xml=str(build / "results/cocotb-r5900-dsll32-differential.xml"),
    )
