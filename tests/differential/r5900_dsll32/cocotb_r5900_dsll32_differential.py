"""Randomized differential verification for R5900 DSLL32."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_dsll32
...
@cocotb.test()
async def test_dsll32_against_python_model(dut) -> None:
    ...
    for iteration, (destination, source, count) in enumerate((*boundaries, *random_cases)):
        instruction = encode_dsll32(destination, source, count)
