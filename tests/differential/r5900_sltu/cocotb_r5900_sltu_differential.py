"""Randomized differential verification for R5900 SLTU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_sltu
...
@cocotb.test()
async def test_r5900_sltu_against_python_model(dut) -> None:
