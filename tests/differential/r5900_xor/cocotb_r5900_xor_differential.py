"""Randomized differential verification for R5900 XOR."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_xor
...
@cocotb.test()
async def test_r5900_xor_against_python_model(dut) -> None:
