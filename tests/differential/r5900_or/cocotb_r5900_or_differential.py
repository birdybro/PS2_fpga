"""Randomized differential verification for R5900 OR."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_or
...
@cocotb.test()
async def test_r5900_or_against_python_model(dut) -> None:
