"""Randomized differential verification for R5900 AND."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_and
...
@cocotb.test()
async def test_r5900_and_against_python_model(dut) -> None:
