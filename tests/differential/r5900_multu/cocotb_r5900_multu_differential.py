"""Randomized differential verification for R5900 unsigned word MULTU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_multu
...
async def execute_case(
    ...
    """Execute and compare one complete differential MULTU transition."""
...
@cocotb.test()
async def test_r5900_multu_against_python_architectural_model(dut) -> None:
    """Compare PC, GPRs, both accumulator lanes, and events over MULTU cases."""
