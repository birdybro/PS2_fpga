"""Randomized differential verification for R5900 DSRAV."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_dsrav
...
@cocotb.test()
async def test_dsrav_against_python_model(dut) -> None:
    ...
    for iteration, (destination, source, shift_register) in enumerate((*boundaries, *random_cases)):
        instruction = encode_dsrav(destination, source, shift_register)
