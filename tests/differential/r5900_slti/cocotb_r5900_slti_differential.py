"""Randomized differential verification for R5900 SLTI."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_slti
...
@cocotb.test()
async def test_r5900_slti_against_python_model(dut) -> None:
