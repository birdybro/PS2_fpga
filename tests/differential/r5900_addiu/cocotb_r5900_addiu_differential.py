"""Randomized differential verification for R5900 ADDIU."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_addiu
...
@cocotb.test()
async def test_r5900_addiu_against_python_model(dut) -> None:
