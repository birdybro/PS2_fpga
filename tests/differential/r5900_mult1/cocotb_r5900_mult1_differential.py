"""Randomized differential verification for R5900 signed word MULT1."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_mult1
...
async def execute_case(
    ...
    """Execute and compare one complete differential MULT1 transition."""
...
@cocotb.test()
async def test_r5900_mult1_against_python_architectural_model(dut) -> None:
    """Compare PC, GPRs, both accumulator lanes, and events over MULT1 cases."""
