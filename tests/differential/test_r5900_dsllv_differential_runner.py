"""Pytest orchestration for differential R5900 DSLLV tests."""
...
TEST_DIR = Path(__file__).resolve().parent / "r5900_dsllv"
HARNESS = ROOT / "tests/unit/r5900_shift_immediate"


@pytest.mark.differential
@pytest.mark.randomized
def test_r5900_dsllv_randomized_differential() -> None:
    sources = [
    ...
    directory = build / "pytest/r5900_dsllv_differential"
    ...
    result = runner.test(
        test_module="cocotb_r5900_dsllv_differential",
        hdl_toplevel="r5900_shift_immediate_top",
        build_dir=directory,
        test_dir=TEST_DIR,
        seed=int(os.environ.get("RANDOM_SEED", "1")),
        results_xml=str(build / "results/cocotb-r5900-dsllv-differential.xml"),
    )
