"""Pytest orchestration for randomized differential R5900 SLL verification."""
...
def test_r5900_sll_randomized_differential() -> None:
    """Compare SLL PC, all GPRs, writeback, and retirement to the Python model."""
    seed = int(os.environ.get("RANDOM_SEED", "1"))
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_sll_differential"
    results_path = build_root / "results" / "cocotb-r5900-sll-differential.xml"
