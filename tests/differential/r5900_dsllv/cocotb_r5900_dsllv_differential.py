"""Randomized differential verification for R5900 DSLLV."""
...
from reference.ee.r5900 import GPR_COUNT, GPR_WIDTH, R5900State, encode_dsllv
...
@cocotb.test()
async def test_dsllv_against_python_model(dut) -> None:
    ...
    controlled_values = {
        ...
        6: 64,
        7: (1 << GPR_WIDTH) - 1,
        10: 0xDEAD_BEEF_CAFE_F00D_0000_0001_0000_0001,
    }
    ...
    for iteration, (destination, source, shift_register) in enumerate((*boundaries, *random_cases)):
        instruction = encode_dsllv(destination, source, shift_register)
