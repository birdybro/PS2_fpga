...
@cocotb.test()
async def test_r5900_decode_recognizes_canonical_dsrav_encodings(dut) -> None:
    """Admit all DSRAV register fields while reserved sa stays zero."""
    for rs, rt, rd in (
        (0, 0, 0),
        (1, 0, 0),
        (0, 1, 0),
        ...
        word = (rs << 21) | (rt << 16) | (rd << 11) | 0x17
        await check_decode(dut, word, True, OPERATION_DSRAV)
...
@cocotb.test()
async def test_r5900_decode_recognizes_every_daddiu_register_and_immediate_field(dut) -> None:
    """Admit DADDIU across the complete architectural rs and rt field ranges."""
    for rs, rt, immediate in (
        (0, 0, 0),
        (1, 0, 1),
        (0, 1, 0x7FFF),
        ...
        word = (0x19 << 26) | (rs << 21) | (rt << 16) | immediate
        await check_decode(dut, word, True, OPERATION_DADDIU)
...
@cocotb.test()
async def test_r5900_decode_recognizes_every_daddu_register_field(dut) -> None:
    """Admit all DADDU register fields while its reserved shift field stays zero."""
    for rs, rt, rd in (
        (0, 0, 0),
        (1, 0, 0),
        (0, 1, 0),
        ...
        word = (rs << 21) | (rt << 16) | (rd << 11) | 0x2D
        await check_decode(dut, word, True, OPERATION_DADDU)


@cocotb.test()
async def test_r5900_decode_recognizes_every_dsubu_register_field(dut) -> None:
    """Admit all DSUBU register fields while its reserved shift field stays zero."""
    for rs, rt, rd in (
        (0, 0, 0),
        (1, 0, 0),
        (0, 1, 0),
        ...
        word = (rs << 21) | (rt << 16) | (rd << 11) | 0x2F
        await check_decode(dut, word, True, OPERATION_DSUBU)
...
@cocotb.test()
async def test_r5900_decode_recognizes_multu_with_optional_destination(dut) -> None:
    """Admit unsigned MULTU with any source or optional rd and reserved sa zero."""
    for rs, rt, rd in (
        (0, 0, 0),
        (1, 0, 0),
        (0, 1, 0),
        ...
        word = (rs << 21) | (rt << 16) | (rd << 11) | 0x19
        await check_decode(dut, word, True, OPERATION_MULTU)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_div_encodings(dut) -> None:
    """Admit signed DIV sources only when the reserved rd and sa fields are zero."""
    for rs, rt in ((0, 0), (1, 0), (0, 1), (31, 31), (23, 17)):
        word = (rs << 21) | (rt << 16) | 0x1A
        await check_decode(dut, word, True, OPERATION_DIV)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_divu_encodings(dut) -> None:
    """Admit DIVU sources only when the reserved rd and sa fields are zero."""
    for rs, rt in ((0, 0), (1, 0), (0, 1), (31, 31), (23, 17)):
        word = (rs << 21) | (rt << 16) | 0x1B
        await check_decode(dut, word, True, OPERATION_DIVU)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_mfhi_encodings(dut) -> None:
    """Admit every MFHI destination only when all reserved fields are zero."""
    for rd in (0, 1, 17, 31):
        await check_decode(dut, (rd << 11) | 0x10, True, OPERATION_MFHI)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_mflo_encodings(dut) -> None:
    """Admit every MFLO destination only when all reserved fields are zero."""
    for rd in (0, 1, 17, 31):
        await check_decode(dut, (rd << 11) | 0x12, True, OPERATION_MFLO)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_mthi_encodings(dut) -> None:
    """Admit every MTHI source only when all reserved fields are zero."""
    for rs in (0, 1, 17, 31):
        await check_decode(dut, (rs << 21) | 0x11, True, OPERATION_MTHI)
...
@cocotb.test()
async def test_r5900_decode_recognizes_canonical_multu1_encodings(dut) -> None:
    """Admit all MULTU1 register fields under MMI when reserved sa is clear."""
    for rs, rt, rd in ((0, 0, 0), (1, 0, 0), (0, 1, 0), (0, 0, 1), (31, 31, 31)):
        word = (0x1C << 26) | (rs << 21) | (rt << 16) | (rd << 11) | 0x19
        await check_decode(dut, word, True, OPERATION_MULTU1)


@cocotb.test()
async def test_r5900_decode_recognizes_canonical_div1_encodings(dut) -> None:
    """Admit DIV1 sources under MMI only when reserved rd and sa stay clear."""
    for rs, rt in ((0, 0), (1, 0), (0, 1), (31, 31), (23, 17)):
        word = (0x1C << 26) | (rs << 21) | (rt << 16) | 0x1A
        await check_decode(dut, word, True, OPERATION_DIV1)
...
@cocotb.test()
async def test_r5900_decode_recognizes_canonical_mfhi1_encodings(dut) -> None:
    """Admit every MFHI1 destination under MMI when reserved fields stay clear."""
    for rd in range(32):
        word = (0x1C << 26) | (rd << 11) | 0x10
        await check_decode(dut, word, True, OPERATION_MFHI1)
...
async def test_r5900_decode_rejects_unsupported_or_reserved_special_encodings(dut) -> None:
    ...
    for value in (1, 1 << 4, 0x1F):
        ...
        await check_decode(dut, (value << 6) | 0x1A, False, OPERATION_NONE)
        await check_decode(dut, (value << 11) | 0x1A, False, OPERATION_NONE)
        await check_decode(dut, (value << 6) | 0x1B, False, OPERATION_NONE)
        await check_decode(dut, (value << 11) | 0x1B, False, OPERATION_NONE)
        await check_decode(dut, (value << 21) | 0x10, False, OPERATION_NONE)
        await check_decode(dut, (value << 16) | 0x10, False, OPERATION_NONE)
        await check_decode(dut, (value << 6) | 0x10, False, OPERATION_NONE)
        await check_decode(dut, (value << 21) | 0x12, False, OPERATION_NONE)
        await check_decode(dut, (value << 16) | 0x12, False, OPERATION_NONE)
        await check_decode(dut, (value << 6) | 0x12, False, OPERATION_NONE)
        ...
        await check_decode(dut, (value << 6) | 0x19, False, OPERATION_NONE)
        ...
        await check_decode(dut, (value << 6) | 0x2D, False, OPERATION_NONE)
        await check_decode(dut, (value << 6) | 0x2F, False, OPERATION_NONE)
