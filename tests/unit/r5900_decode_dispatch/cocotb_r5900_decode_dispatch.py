...
@cocotb.test()
async def test_r5900_decode_dispatch_sends_canonical_mtlo_to_execute(dut) -> None:
    """Dispatch every canonical MTLO source without diagnostics."""
    for pc, instruction in ((0, 0x13), (4, 0x0020_0013), (0x0010_0000, 0x03E0_0013)):
        await check_dispatch(dut, (True, pc, instruction), (True, OPERATION_MTLO, False))


@cocotb.test()
async def test_r5900_decode_dispatch_sends_canonical_mult1_to_execute(dut) -> None:
    """Dispatch canonical MMI MULT1 register fields without diagnostics."""
    for pc, instruction in ((0, 0x7000_0018), (4, 0x7020_0018), (0x0010_0000, 0x72FF_F818)):
        await check_dispatch(dut, (True, pc, instruction), (True, OPERATION_MULT1, False))


@cocotb.test()
async def test_r5900_decode_dispatch_sends_canonical_multu1_to_execute(dut) -> None:
    """Dispatch canonical MMI MULTU1 register fields without diagnostics."""
    for pc, instruction in ((0, 0x7000_0019), (4, 0x7020_0019), (0x0010_0000, 0x72FF_F819)):
        await check_dispatch(dut, (True, pc, instruction), (True, OPERATION_MULTU1, False))
...
@cocotb.test()
async def test_r5900_decode_dispatch_sends_canonical_divu1_to_execute(dut) -> None:
    """Dispatch canonical MMI DIVU1 source fields without diagnostics."""
    for pc, instruction in ((0, 0x7000_001B), (4, 0x7020_001B), (0x0010_0000, 0x73FF_001B)):
        await check_dispatch(dut, (True, pc, instruction), (True, OPERATION_DIVU1, False))


@cocotb.test()
async def test_r5900_decode_dispatch_sends_canonical_mfhi1_to_execute(dut) -> None:
    """Dispatch canonical MMI MFHI1 destinations without diagnostics."""
    for pc, instruction in ((0, 0x7000_0010), (4, 0x7000_0810), (0x0010_0000, 0x7000_F810)):
        await check_dispatch(dut, (True, pc, instruction), (True, OPERATION_MFHI1, False))
