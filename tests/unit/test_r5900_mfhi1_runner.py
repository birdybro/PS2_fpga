"""Pytest orchestration for directed R5900 MFHI1 tests."""
...
@pytest.mark.unit
def test_r5900_mfhi1_directed() -> None:
    ...
    build_dir = build_root / "pytest" / "r5900_mfhi1_directed"
    ...
    result = runner.test(
        test_module="cocotb_r5900_mfhi1",
        hdl_toplevel="r5900_mult_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-mfhi1-directed.xml"),
    )
