"""Pytest orchestration for directed R5900 DSRL execution tests."""
...
@pytest.mark.unit
def test_r5900_dsrl_directed() -> None:
    """Verify DSRL encoding, width rules, aliases, boundaries, and events."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_dsrl_directed"
    results_path = build_root / "results" / "cocotb-r5900-dsrl-directed.xml"
