"""Pytest orchestration for directed R5900 SRLV execution tests."""
...
@pytest.mark.unit
def test_r5900_srlv_directed() -> None:
    """Verify SRLV masking, logical width rules, aliases, legality, and events."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_srlv_directed"
    results_path = build_root / "results" / "cocotb-r5900-srlv-directed.xml"
