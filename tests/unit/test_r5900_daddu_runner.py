"""Pytest orchestration for directed R5900 DADDU tests."""
...
@pytest.mark.unit
def test_r5900_daddu_directed() -> None:
    sources = [
    ...
    build_dir = build_root / "pytest" / "r5900_daddu_directed"
    ...
    result = runner.test(
        test_module="cocotb_r5900_daddu",
        hdl_toplevel="r5900_shift_immediate_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-daddu-directed.xml"),
    )
