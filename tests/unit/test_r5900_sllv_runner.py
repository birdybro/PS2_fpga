"""Pytest orchestration for directed R5900 SLLV execution tests."""
...
@pytest.mark.unit
def test_r5900_sllv_directed() -> None:
    """Verify SLLV masking, width rules, aliases, legality, and events."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_sllv_directed"
    results_path = build_root / "results" / "cocotb-r5900-sllv-directed.xml"
