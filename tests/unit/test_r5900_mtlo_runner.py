"""Pytest orchestration for directed R5900 MTLO tests."""
...
@pytest.mark.unit
def test_r5900_mtlo_directed() -> None:
    ...
    build_dir = build_root / "pytest" / "r5900_mtlo_directed"
    ...
    result = runner.test(
        test_module="cocotb_r5900_mtlo",
        hdl_toplevel="r5900_mult_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-mtlo-directed.xml"),
    )
