"""Pytest orchestration for directed R5900 DSLL execution tests."""
...
@pytest.mark.unit
def test_r5900_dsll_directed() -> None:
    """Verify DSLL encoding, width rules, aliases, boundaries, and architectural events."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_dsll_directed"
    results_path = build_root / "results" / "cocotb-r5900-dsll-directed.xml"
