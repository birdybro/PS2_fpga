"""Pytest orchestration for directed R5900 DIV tests."""
...
def test_r5900_div_directed() -> None:
    ...
    result = runner.test(
        test_module="cocotb_r5900_div",
        hdl_toplevel="r5900_mult_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-div-directed.xml"),
    )
