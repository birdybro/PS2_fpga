"""Pytest orchestration for directed R5900 DIVU1 tests."""
...
@pytest.mark.unit
def test_r5900_divu1_directed() -> None:
    """Run unsigned quotient, extension, zero-divisor, and legality coverage."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_divu1_directed"
    ...
    result = runner.test(
        test_module="cocotb_r5900_divu1",
        hdl_toplevel="r5900_divu1_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-divu1-directed.xml"),
    )
