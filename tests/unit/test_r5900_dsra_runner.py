"""Pytest orchestration for directed R5900 DSRA execution tests."""
...
@pytest.mark.unit
def test_r5900_dsra_directed() -> None:
    """Verify DSRA encoding, signed rules, aliases, boundaries, and events."""
    build_root = Path(os.environ.get("PS2_BUILD_ROOT", REPO_ROOT / "build"))
    build_dir = build_root / "pytest" / "r5900_dsra_directed"
    results_path = build_root / "results" / "cocotb-r5900-dsra-directed.xml"
