"""Pytest orchestration for directed R5900 MTHI tests."""
...
@pytest.mark.unit
def test_r5900_mthi_directed() -> None:
    ...
    build_dir = build_root / "pytest" / "r5900_mthi_directed"
    ...
    result = runner.test(
        test_module="cocotb_r5900_mthi",
        hdl_toplevel="r5900_mult_top",
        build_dir=build_dir,
        test_dir=TESTBENCH_DIR,
        results_xml=str(build_root / "results/cocotb-r5900-mthi-directed.xml"),
    )
