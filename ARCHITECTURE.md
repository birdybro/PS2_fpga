...
SLLV, SRLV, SRAV, ADDU, SUBU, AND, OR, XOR, NOR, and SLT; and primary-opcode LUI, ORI, ANDI, XORI, and ADDIU
...
preserving its upper lane. The debug interface carries each
retirement record.
